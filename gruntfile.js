...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
      ...
      main: {
        files: [
          ...
          // {expand: true, src: ['js/**/*.js', 'js/**/*.json'], dest: 'www/', filter: 'isFile'},
          {
            ...
            flatten: true,
            src: ['requirejs/require.js', 'bootstrap/dist/css/bootstrap.min.css'],
            dest: '<%=config.build%>',
            filter: 'isFile'
          }
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2015/03/sunday-shows/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2015/03/sunday-shows/': 'style/project.css'
        }
      },
      upload3: {
        files: {
