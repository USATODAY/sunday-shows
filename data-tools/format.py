...
for appearance in appearance_list:
    ...
    if not appearance['Guest'] in people_dict.keys():
        ...
        people_dict[appearance['Guest']] = new_person_dict
    ...
    # if person is already in the dictionary
        ...
        people_dict[appearance["Guest"]]["appearances"].append(new_appearance_dict)
